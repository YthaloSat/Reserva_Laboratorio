    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Eighth navbar example">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample07">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="sistemaProfessor.php">Home</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container my-5">
        <div class="position-relative p-5 text-center text-muted bg-body border border-dashed rounded-5">
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap">
                <a href="historicoReservaProfessor.php" class="btn btn-primary mx-2 my-2 px-5">Histórico de Reservas</a>
                <a href="cadastroReserva.php" class="btn btn-primary mx-2 my-2 px-5">Cadastro de Reservas</a>
            </div>
        </div>
    </div>
